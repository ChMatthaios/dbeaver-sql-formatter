...
INSERT INTO CUSTOMER_STATUS_HISTORY ( CUSTOMER_ID,
                                      ...
                                      CREATED_AT,
                                      CREATED_BY )
VALUES ( 1, 'NEW', 'ACTIVE', 'MANUAL_CHANGE', CURRENT TIMESTAMP, CURRENT USER )
  WITH NC;
...
UPDATE CUSTOMER C
 ...
 WHERE C.CUSTOMER_ID IN (SELECT H.CUSTOMER_ID FROM CUSTOMER_STATUS_HISTORY H WHERE H.NEW_STATUS_CODE = 'ACTIVE')
  WITH NC;
